...
abstract public class JDBCUtil {
    /**
     * An abstract method which child classes override to handle logging of errors
    ...
    /**
     * Checks database metadata to see if a table exists. This method is sensitive
     * to the case of the provided table name.
     *
     * @param dbMetaData the database metadata to be used to look up this table
     ...
     * lower, and MixedCase, both on the table name and the column name, to see if
     * the column is there.
     *
    ...
    /**
     * Checks database metadata to see if a column exists in a table. This method is
     * sensitive to the case of both the provided table name and column name.
     *
     * @param dbMetaData the database metadata to be used to look up this column
     * @param tableName  the case sensitive table name
