...
/**
 * API for other plugins. See the wiki for information on how to correctly
 * access this API: https://github.com/oliverw92/HawkEye/wiki/
 * 
 * @author oliverw92
 */
public class HawkEyeAPI {
	 ...
	 * 
	 * @param plugin instance of your plugin (i.e. just pass 'this' from your main
	 *               class)
