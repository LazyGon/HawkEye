...
public class ContainerAccessManager {
	...
	/**
	 * 'Sets' the player inventory to be open and stores the current contents of the
	 * container
	 * 
	 * @param player player to check
	...
	public class ContainerAccess {
		...
		public ContainerAccess(InventoryHolder container, Player player, HashMap<String, Integer> beforeInv,
				Location loc) {
