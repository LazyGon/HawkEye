...
/**
 * Previews a rollback according to the player's specified input. Error handling
...
public class PreviewCommand extends BaseCommand {
	...
	public void moreHelp() {
		...
		Util.sendMessage(sender,
				"&cThe effects can be applied after using &7/hawk preview apply&c or cancelled using &7/hawk preview cancel");
